...
/opt/tomo --syncmode "full" --announce-txs --datadir $DATA_DIR --networkid $NETWORK_ID --port 30303 --keystore $KEYSTORE_DIR --password $KEYSTORE_DIR/pass.txt --identity $IDENTITY --mine --gasprice 250000000 --bootnodes $BOOTNODES --ethstats $IDENTITY:$WS_SECRET@$NETSTATS_HOST:$NETSTATS_PORT
